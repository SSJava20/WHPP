...
import org.courses.whpp.session.EmployeeFacade;
...
public class EmployeeController implements Serializable {
	...
	@EJB
	private org.courses.whpp.session.EmployeeFacade ejbFacade;
	...
	public static class EmployeeControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
			...
			EmployeeController controller = (EmployeeController) facesContext.getApplication().getELResolver().getValue(facesContext.getELContext(), null, "employeeController");
