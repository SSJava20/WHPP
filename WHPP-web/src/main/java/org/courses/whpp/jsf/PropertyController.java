...
import org.courses.whpp.session.PropertyFacade;
...
public class PropertyController implements Serializable {
	...
	@EJB
	private org.courses.whpp.session.PropertyFacade ejbFacade;
	...
	public static class PropertyControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
			...
			PropertyController controller = (PropertyController) facesContext.getApplication().getELResolver().getValue(facesContext.getELContext(), null, "propertyController");
		...
		public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
			...
			if (object instanceof Property) {
				...
				throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Property.class.getName());
			}
		}
	}
}
