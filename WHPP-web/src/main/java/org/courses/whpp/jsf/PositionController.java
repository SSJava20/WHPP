...
import org.courses.whpp.session.PositionFacade;
...
public class PositionController implements Serializable {
	...
	@EJB
	private org.courses.whpp.session.PositionFacade ejbFacade;
	...
	public static class PositionControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
			...
			PositionController controller = (PositionController) facesContext.getApplication().getELResolver().getValue(facesContext.getELContext(), null, "positionController");
